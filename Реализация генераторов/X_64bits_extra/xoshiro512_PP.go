...
type Xoshiro512_PP struct {
	S [8]uint64
}

func (x Xoshiro512_PP) rotl(a uint64, b int) uint64 {
	return (a << b) | (a >> (64 - b))
}

func (x *Xoshiro512_PP) Next() uint64 {
	var result uint64 = x.rotl(x.S[0]+x.S[2], 17) + x.S[2]
...
func (x *Xoshiro512_PP) Long_jump() {
