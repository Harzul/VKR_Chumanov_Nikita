...
type Xoroshiro1024_M struct {
	S [16]uint64
	P int
}

func (x Xoroshiro1024_M) rotl(a uint64, b int) uint64 {
	return (a << b) | (a >> (64 - b))
}

func (x *Xoroshiro1024_M) Next() uint64 {
	var q = x.P
	var s0 uint64 = x.S[(x.P+1)&15]
	(*x).P = (x.P + 1) & 15
	var s15 uint64 = x.S[q]
	var result uint64 = s0 * 0x9e3779b97f4a7c13
...
func (x *Xoroshiro1024_M) Long_jump() {
