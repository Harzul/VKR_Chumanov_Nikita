...
type Xoshiro512_MM struct {
	S [8]uint64
}

func (x Xoshiro512_MM) rotl(a uint64, b int) uint64 {
	return (a << b) | (a >> (64 - b))
}

func (x *Xoshiro512_MM) Next() uint64 {
...
func (x *Xoshiro512_MM) Long_jump() {
