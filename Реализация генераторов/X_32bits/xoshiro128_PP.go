...
type Xoshiro128_PP struct {
	S [4]uint32
}

func (x Xoshiro128_PP) rotl(a uint32, b int) uint32 {
	return (a << b) | (a >> (32 - b))
}

func (x *Xoshiro128_PP) Next() uint32 {
...
func (x *Xoshiro128_PP) Long_jump() {
