...
type Xoshiro128_MM struct {
	S [4]uint32
}

func (x Xoshiro128_MM) rotl(a uint32, b int) uint32 {
	return (a << b) | (a >> (32 - b))
}

func (x *Xoshiro128_MM) Next() uint32 {
	var result uint32 = x.rotl(x.S[1]*5, 7) * 9
...
func (x *Xoshiro128_MM) Long_jump() {
