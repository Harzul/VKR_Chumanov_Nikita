...
type Xoshiro256_MM struct {
	S [4]uint64
}

func (x Xoshiro256_MM) rotl(a uint64, b int) uint64 {
	return (a << b) | (a >> (64 - b))
}

func (x *Xoshiro256_MM) Next() uint64 {
	var result uint64 = x.rotl(x.S[1]*5, 7) * 9
...
func (x *Xoshiro256_MM) Long_jump() {
